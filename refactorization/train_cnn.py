...
from refactorization.config.defaults_cnn import cfg
from common.utils.cfg_utils import purge_cfg
from refactorization.models_cnn.build import build_model
from refactorization.datasets.build import build_cnn_dataloader
...
def main():
    ...
    set_random_seed(cfg.RNG_SEED)
    train_dataloader = build_cnn_dataloader(cfg, True, start_iter)
    ...
    if do_validation:
        val_dataloader = build_cnn_dataloader(cfg, training=False)
